...
const literalSchema = z4.union([z4.string(), z4.number(), z4.boolean(), z4.null()]);
const jsonSchema: z.$ZodType = z4.lazy(() =>
	z4.union([literalSchema, z4.array(jsonSchema), z4.record(z4.string(), jsonSchema)])
);
...
const potential_schemas = [
	...
	z4.unknown(),
	z4.nan(),
	z4.record(any, any), //`z.object` is just a subset of this - no need for a separate case.

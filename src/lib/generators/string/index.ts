...
export type StringKindGenerator = <Z extends z.ZodString>(ctx: GenerationContext<Z>, lc: LengthConstraints, cc: ContentConstraints, td: TransformDefinition) => string;
 ...
 */
function length_constraints<Z extends z.ZodString>(schema: Z): LengthConstraints {
